...
require (
	...
	github.com/nicolebroyak/niqurl/config/niqurlconfigs v0.0.0-20220620160756-44874244485a
	github.com/nicolebroyak/niqurl/tools/randomusers v0.0.0-20220620160756-44874244485a
	github.com/nicolebroyak/niqurl/tools/redishandler v0.0.0-20220620160756-44874244485a
	github.com/nicolebroyak/niqurl/tools/urlhandler v0.0.0-20220620160756-44874244485a
)
